...
export default function AIChatPage() {
  return (
    <div className="fixed inset-0 w-screen bg-[#F5F7FA]">
      <div className="relative mx-auto max-w-[1920px] h-full">
        ...
        <div className="ml-[361px] h-full flex flex-col">
          ...
          {/* Main content area */}
          <div className="flex-1 flex flex-col items-center px-4 relative overflow-hidden">
            <div className="h-full w-full overflow-y-auto">
              <h1 className="text-[48px] font-semibold font-roboto mb-4 text-center mt-4">
